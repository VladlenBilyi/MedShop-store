                ...
                <SimpleGrid columns={[1,1,3,3]} gap="0px">
                    <Container  w="300px"  padding="20px" >
                        ...
                        <Flex gap="15px"  marginTop="10px">
                            ...
                            <Box borderRadius="5px" padding="10px" border="1px solid grey">
                                <Image margin="auto" boxSize="100px" src={data1?.img3} /></Box>
                        </Flex>
                        <Text marginTop="10px" color="grey" fontSize="12px">Non Returnable</Text>
                    </Container>
                    <Container w={["300px","450px"]}  padding="25px" >

                        <Text fontWeight="bold" color="rgb(79, 88, 94)" fontSize={["20px","25px"]} fontFamily="sans-serif">{data1?.title}</Text>
                        <Text fontWeight="semibold" color="rgb(16,132,126)" fontSize={["15px","20px"]} fontFamily="sans-serif">{data1?.ancestor[1]}</Text>
                        <Flex padding="20px">
                            <Box>
                                <Flex alignItems="center" >

                                    <BiRupee fontSize="40px" />
                                    <Text fontWeight="bold"  fontSize="20px">{data1?.mrp}</Text>
                                    <Text marginLeft="15px" marginRight="5px" fontSize="15px">MRP-</Text>
                                    <Text fontSize="15px" marginRight="20px" textDecorationLine="line-through">{data1?.strike}</Text>
                                    <Flex w="100%" alignItems="center" paddingLeft="10px" color="white" borderRadius="10px" bg="rgb(249,140,142)"  >
                                        <BiRupee fontSize="15px" />
                                        <Text w="45px" >{Math.floor(data1?.strike-data1?.mrp)} off</Text>
                                    </Flex>
                                </Flex>
                        ...
                        <Box>
                                <Button onClick={postProduct}  _hover={{ bg: "teal.300" }} color="white" bg="rgb(16,132,126)">Add To Cart</Button>
                            </Box>
                    </Container>
