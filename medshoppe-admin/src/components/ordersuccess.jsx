...
function OrderSuccess({show , handleShow}){
  ...
  .then((er)=>er.json()).then((er)=>{
   if(er.data.length !==0){
    ...
    return <Flex w='100%'>
             ...
             <Flex w='100%'>
              <Box onClick={()=>handleShow(false)} w='50%' bg='white'  fontWeight='500' textAlign='center' p='10px'>Pending Order</Box>
              <Box onClick={()=>handleShow(true)} w='50%' bg='white' color='#006600' borderBottom='3px solid #006600' fontWeight='500' textAlign='center' p='10px'>Success Order</Box>
             </Flex>
